...
O hero oficial está em `images/new-hero.jpg`, com a composição vertical otimizada para celulares em `images/mobile-hero.webp`, e o selo vetorial de garantia em `images/7-dias-vetor.svg`. As fotos editoriais, curvas, ícones e demais elementos gráficos do layout estão em `images/figma/`; nenhum deles depende dos links temporários do Figma.
